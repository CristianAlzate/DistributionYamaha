...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addBikes = function () {
    ...
    AppComponent.prototype.addTruck = function () {
        var newDistributionTruck = new _models_shipment_model__WEBPACK_IMPORTED_MODULE_6__["TruckDistribution"]();
        newDistributionTruck.Truck = this._selectedTruck;
        var newTruckDistSecondF = new _models_shipment_model__WEBPACK_IMPORTED_MODULE_6__["TruckDistributionFloor"]();
        ...
        var newTruckDistFirstF = new _models_shipment_model__WEBPACK_IMPORTED_MODULE_6__["TruckDistributionFloor"]();
    ...
    AppComponent.prototype.cleanDistribution = function () {
        this.shipment = new _models_shipment_model__WEBPACK_IMPORTED_MODULE_6__["ShipmentModel"]();
    ...
    AppComponent.prototype.distribute = function () {
        var _this = this;
        this._showAlertDistribute = false;
        var i = 0;
        var truckChange = false;
        var detailChange = false;
        var orderChange = false;
        var floorChange = false;
        debugger;
        if (this.shipment.Orders.length > 0 && this.shipment.Trucks.length > 0) {
            this.shipment.Trucks.forEach(function (truckDist) {
                truckDist.TruckFloor.forEach(function (floor) {
                    floorChange = false;
                    _this.shipment.Orders.forEach(function (ord) {
                        //if(!truckChange && !detailChange && !floorChange && !orderChange){
                        ord.Details.forEach(function (orderDetail) {
                            var cont = orderDetail.Quantity - orderDetail.QuantityLeft;
                            orderDetail.Quantity = orderDetail.QuantityLeft;
                            if (!floorChange) {
                                for (var j = 0; j < orderDetail.Quantity; j++) {
                                    if (orderDetail.Bike.Width < floor.LeftSideSpace) {
                                        var bike = Object.assign({}, orderDetail.Bike);
    ...
    AppComponent.prototype.saveNewOrder = function () {
    ...
    AppComponent.prototype.viewDetail = function (order) {
        order.ViewDetail = !order.ViewDetail;
    };
    AppComponent.prototype.addOrderToDistribute = function (order) {
        order.Sent = true;
        var cloneOrder = JSON.parse(JSON.stringify(order));
        ...
        //
        cloneOrder.Details.forEach(function (element) {
            element.QuantityLeft = element.Quantity;
        });
        this.shipment.Orders.push(cloneOrder);
        this.shipment.Orders = this.shipment.Orders.sort(function (n1, n2) {
    ...
    AppComponent.prototype.clone = function (obj) {
    ...
    AppComponent.prototype.initialData = function () {
        var customer1 = new _models_customer_model__WEBPACK_IMPORTED_MODULE_2__["CustomerModel"]();
        customer1 = {
        ...
        var customer2 = new _models_customer_model__WEBPACK_IMPORTED_MODULE_2__["CustomerModel"]();
        customer2 = {
        ...
        var customer3 = new _models_customer_model__WEBPACK_IMPORTED_MODULE_2__["CustomerModel"]();
        customer3 = {
        ...
        var bike1 = new _models_bike_model__WEBPACK_IMPORTED_MODULE_3__["BikeModel"]();
        bike1 = {
            BikeId: 1,
            BikeReference: "BWS",
            Width: 43.7
        };
        var bike2 = new _models_bike_model__WEBPACK_IMPORTED_MODULE_3__["BikeModel"]();
        bike2 = {
            BikeId: 2,
            BikeReference: "NMAX",
            Width: 47.1
        };
        var bike3 = new _models_bike_model__WEBPACK_IMPORTED_MODULE_3__["BikeModel"]();
        bike3 = {
            BikeId: 3,
            BikeReference: "FZ15",
            Width: 38.3
        };
        var bike4 = new _models_bike_model__WEBPACK_IMPORTED_MODULE_3__["BikeModel"]();
        bike4 = {
            BikeId: 4,
        ...
        var truck1 = new _models_truck_model__WEBPACK_IMPORTED_MODULE_5__["TruckModel"]();
        truck1 = {
            TruckId: 1,
            TruckReference: "Sencillo",
            Length: 670
        };
        var truck2 = new _models_truck_model__WEBPACK_IMPORTED_MODULE_5__["TruckModel"]();
        truck2 = {
            TruckId: 2,
            TruckReference: "Dobletroque",
            Length: 730
        };
        var truck3 = new _models_truck_model__WEBPACK_IMPORTED_MODULE_5__["TruckModel"]();
        truck3 = {
            TruckId: 3,
            TruckReference: "Camioneta",
            Length: 520
        };
        var truck4 = new _models_truck_model__WEBPACK_IMPORTED_MODULE_5__["TruckModel"]();
        truck4 = {
            TruckId: 4,
        ...
        var order1 = new _models_order_model__WEBPACK_IMPORTED_MODULE_4__["OrderModel"]();
...
var TruckDistribution = /** @class */ (function () {
    function TruckDistribution() {
        this.TruckFloor = [];
    }
    return TruckDistribution;
}());

var TruckDistributionFloor = /** @class */ (function () {
    function TruckDistributionFloor() {
        this.BikesLeft = [];
        this.BikesRight = [];
        this.RightSidePositionSlots = 3;
    }
    return TruckDistributionFloor;
}());
